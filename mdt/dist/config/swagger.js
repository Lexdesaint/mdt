...
const options = {
    definition: {
        ...
        servers: [
            {
                url: `http://localhost:${env_1.SERVER_PORT}`,
    ...
    apis: [
        path_1.default.join(basePath, `api/*/route.${fileExtension}`),
        path_1.default.join(basePath, `api/*/routes.${fileExtension}`),
        path_1.default.join(basePath, `routes/*.${fileExtension}`)
